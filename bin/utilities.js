    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (_packageRef === undefined) {
            ...
            if (_packageRef === undefined) {
                ...
                params.setName("eas");
                params.setVersion("1.16.1");
                params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2ZpbnRyZWFsL2VhcyIsInZlcnNpb24iOiIxLjE2LjEifX0="), c => c.charCodeAt(0)));
